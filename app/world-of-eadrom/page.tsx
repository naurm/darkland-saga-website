    ...
    <>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-32 pb-12 text-center">
        ...
        <p className="mt-4 text-sm text-parchment-400 max-w-lg mx-auto leading-relaxed">
          ...
          understanding. What follows begins near the base and climbs. Scroll down to ascend.
        </p>
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="#the-pillar" className="inline-flex items-center gap-2 rounded border border-ember-600 bg-ember-700/20 px-5 py-2.5 font-mono text-sm text-ember-300 hover:bg-ember-700/40 transition-all">Ascend</Link>
      ...
      {/* Lore — lowest floor first, scroll down to ascend */}
